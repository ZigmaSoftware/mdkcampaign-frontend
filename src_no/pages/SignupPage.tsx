      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-[440px] page-enter">
          ...
          <div className="text-center mb-7">
            {/* Lotus icon — BJP symbol */}
            <div
              className="inline-flex items-center justify-center w-[72px] h-[72px] rounded-full bg-navy mb-4 shadow-[0_4px_24px_rgba(13,36,85,0.25)]"
            >
              <i
                className="ph ph-flower-lotus text-saffron text-[38px] leading-none"
            ...
            <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${role === r
                          ...
                          : 'border-border bg-[#f8fafc] hover:border-saffron/40'}
                      `}
                    >
                      <i className={`
                        text-[26px]
                        ${r === 'admin' ? 'ph-fill ph-shield-star' : 'ph-fill ph-user-circle'}
                        ${role === r ? 'text-saffron' : 'text-muted'}
                      `} />
                      <div className="text-center">
                        <span className={`block text-[12px] font-bold capitalize ${role === r ? 'text-navy' : 'text-muted'}`}>
                          {r === 'admin' ? 'Administrator' : 'Field User'}
                        </span>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="new-password"
                    className={`
                      w-full pl-9 pr-10 py-[10px] rounded-lg border text-[13px] font-medium
                      bg-[#f8fafc] text-textMain
                      focus:outline-none focus:ring-2 focus:ring-saffron/40 focus:border-saffron
                      transition-all duration-150 placeholder:text-[#b0b8c4]
              ...
              >
                {loading ? (
                  ...
                  <>
                    <i className="ph ph-user-plus text-[16px]" />
                    Create Account
                  </>
                )}
              </button>
